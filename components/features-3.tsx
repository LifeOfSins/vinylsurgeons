        ...
        <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    <h2 className="text-balance text-2xl font-semibold lg:text-5xl">Our surgical precision ensures every car looks flawless</h2>
                    <p className="mt-4">Treat your ride like a patient — expert vinyl wraps and styling performed with precision.</p>
                </div>
